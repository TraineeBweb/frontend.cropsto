...
<head runat="server">
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-GL7QJ3PC9N"></script>
...
<body class="counter-scroll">
 ...
 <div class="whatsapp-icon">
            <a href="https://api.whatsapp.com/send?phone=919825213170" target="_blank"><img src="images/whatsapp.png" alt=""></a>
        </div>
        <!-- Top-bar -->
        <div class="tf-topbar">
                    ...
                    <div class="col-lg-12">
                        <div class="topbar-inner">
                            <div class="topbar-left">
                                ...
                                <span class="fs-14 font-cropsto">Sustainably Preserving Freshness</span>
                            </div>
                            <div id="google_translate_element"></div>
                            <div class="topbar-right">
                                <ul class="social-list">
                                    <li class="item">
                                        <a href="https://www.facebook.com/CropstoPackaging" target="_blank">
                                            <i class="icon-facebook"></i>
                                        </a>
                                    </li>
                                    <li class="item">
                                        <a href="https://www.linkedin.com/company/cropsto-pack" target="_blank">
                                            <i class="fa-brands fa-linkedin-in"></i>
                                        </a>
                                    </li>
                                    <li class="item">
                                        <a href="https://www.instagram.com/cropsto/" target="_blank">
                    ...
                    <div class="col-lg-12">
                        <div class="header-inner">
                                ...
                                <ul class="nav-list">
                                    ...
                                    <li class="item has-child">
                                        ...
                                        <ul class="sub-nav">
                                            ...
                                            <li>
                                                <a href="initiatives.html"><span>Initiatives
                                                </span>
                                                </a>
                                            </li>
                                        </ul>
                            ...
                            <div class="header-right">
                                <a href="contact.aspx" class="tf-btn gap-30">
                                    <span class="text-style">Get In Touch!
                                    </span>
                                    <div class="icon">
                        ...
                        <div class="mobile-nav-wrap">
                                ...
                                <div class="top">
                                    ...
                                    <nav id="mobile-main-nav" class="mobile-main-nav">
                                        <ul id="menu-mobile-menu" class="menu">
                                            ...
                                            <li class="menu-item menu-item-has-children-mobile ">
                                                <a class="item-menu-mobile" href="javascript:void(0)">Sustainability
                          <i class="icon-arrow_down"></i>
                                            ...
                                            <li class="menu-item menu-item-has-children-mobile">
                                                <a class="item-menu-mobile" href="dynamic/">Blog</a>
                                            </li>
                                            <li class="menu-item menu-item-has-children-mobile current-nav">
                                                <a class="item-menu-mobile current" href="contact.aspx">Contact Us</a>
                                            </li>
                                        </ul>
                                    </nav>
                                </div>
                                    ...
                                    <div class="infor-list">
                                        <ul>
                                            <li>
                                                ...
                                                <p>
                                                    B/h. Rajkamal Petrol Pump, Gondal road, Rajkot -360004 (Gujarat)
                          INDIA.
                                                </p>
                                            </li>
                                            <li>
                                    ...
                                    <div class="wg-social">
                                        <ul class="list">
                                            <li class="item">
                                                <a href="https://www.facebook.com/CropstoPackaging" target="_blank"><i
                                                    class="icon-facebook1"></i></a>
                                            </li>
                                            <li class="item">
                                                <a href="https://www.instagram.com/cropsto/" target="_blank"><i class="icon-instagram2"></i></a>
                                            </li>
                                            <li class="item">
                                                <a href="https://www.linkedin.com/company/cropsto-pack" target="_blank">
                        ...
                        <div class="row">
                                    ...
                                    <ul class="contact-list">
                                        <li class="wow fadeInUp" data-wow-duration="1.4s">
                                            ...
                                            <div class="infor">
                                                ...
                                                <p class="text">
                                                    B/h. Rajkamal Petrol Pump, Gondal road, Rajkot -360004 (Gujarat) INDIA.
                                                </p>
                                            </div>
                                        </li>
                                        <li class="wow fadeInUp" data-wow-duration="1.4s">
                            ...
                            <div class="col-lg-7">
                                <div class="content-section">
                                    ...
                                    <form class="form-send-message style-2" id="form" runat="server">                                        
                                        <div class="cols style-2 mb-15">
                                            <fieldset>
                                                <asp:TextBox runat="server" CssClass="form-control" ID="txtname" name="first_name" placeholder="Name*"
                                            ...
                                            <fieldset>
                                                <asp:TextBox runat="server" CssClass="form-control" ID="txtemail" name="email_id" placeholder="Email*"></asp:TextBox>
                                        ...
                                        <div class="cols style-2 mb-15">
                                            <fieldset>
                                                <asp:TextBox runat="server" CssClass="form-control" ID="txtphone" name="phone_no" placeholder="Phone*" aria-required="true"></asp:TextBox>
                                                <asp:RequiredFieldValidator ID="rfvPhone" runat="server" ControlToValidate="txtphone" ErrorMessage="Phone number is required."
                                                    ForeColor="Red" Display="Dynamic" />
                                                <asp:RegularExpressionValidator ID="revPhone" runat="server" ControlToValidate="txtphone"
                                                    ValidationExpression="^\d{10}$" ErrorMessage="Enter a 10-digit phone number." ForeColor="Red" Display="Dynamic" />
                                            </fieldset>

                                            <fieldset>
                                                <asp:TextBox runat="server" CssClass="form-control" ID="txtsubject" name="subject" placeholder="Subject*" aria-required="true"></asp:TextBox>
                                                <asp:RequiredFieldValidator ID="rfvSubject" runat="server" ControlToValidate="txtsubject" ErrorMessage="Subject is required."
                                                    ForeColor="Red" Display="Dynamic" />
                                            </fieldset>
                                        </div>
                                        ...
                                        <div class="cols mb-30">
                                            <fieldset>
                                                <asp:TextBox ID="txtmessage" runat="server" name="massage" placeholder="Message..." TextMode="MultiLine" Rows="4" Columns="50"></asp:TextBox>
                                        ...
                                        <div class="cols justify-content-start cols mb-30 w-100">
                                            <div class="form-grp d-flex w-100">
                                                ...
                                                <asp:Label ID="lblNum1" runat="server" Text="" CssClass="form-control"></asp:Label>
                                                    <span class="cc99">+</span>
                                                <asp:Label ID="lblNum2" runat="server" Text="" CssClass="form-control"></asp:Label>
                                                <span class="cc99">=</span>
                                                <asp:TextBox ID="txtCaptcha" runat="server" CssClass="form-control"></asp:TextBox>
                                                <asp:RequiredFieldValidator ID="rfvCaptcha" runat="server" ControlToValidate="txtCaptcha" ErrorMessage="Captcha is required."
                                                    ForeColor="Red" Display="Dynamic" />
                                            </div>
                                        </div>
                                        <div class="checkbox-item send-wrap">

                                            <asp:Button ID="btnsubmit" runat="server" Text="Send Message" OnClick="btnsubmit_Click" class="tf-btn">
        ...
        <footer class="footer" id="footer-main">
                            ...
                            <div class="footer-right">
                                <div class="wg-social">
                                    <ul class="list">
                                        ...
                                        <li class="item">
                                            <a href="https://www.linkedin.com/company/cropsto-pack" target="_blank"><i
            ...
            <div class="footer-inner">
                <div class="tf-container w-1290">
                    <div class="row">
                        <div class="col-lg-3 col-md-6 ">
                            <div class="footer-inner-wrap footer-col-block">
                                <h4 class="footer-title footer-title-desktop mb-23">ISO 22000: 2018 Certified Company
                                </h4>
                                <h4 class="footer-title footer-title-mobile mb-23">ISO 22000: 2018 Certified Company
                                </h4>
                                <p class="cc2">
                                    Cropsto is all about superior quality high barrier hermetic packaging/storage
                  solutions for green coffee, cocoa, tea, sugar, rice, spices, maze and other grains,
                  used as inner liner for jute bags or ordinary sacks.
                        ...
                        <div class="col-lg-3 col-md-6 ">
                            <div class="footer-inner-wrap footer-col-block">
                                <h4 class="footer-title footer-title-desktop mb-23">News Posts
                                </h4>
                                <h4 class="footer-title footer-title-mobile mb-23">News Posts
                                </h4>
                                <ul class="new-post-list tf-collapse-content">
                                    <li class="item img-hover">
                                        ...
                                        <div class="content">
                                            <a href="blog-coffee-flavours.html" class="title-post hover-text-secondary">Coffee Flavors around the World!
                                            </a>
                                    ...
                                    <li class="item img-hover">
                                        ...
                                        <div class="content">
                                            <a href="blog-sustainability-in-coffee-packaging.html" class="title-post hover-text-secondary">Sustainability in Coffee...
                                            </a>
                                            <p class="date-release">
                                                30 Sep, 2024
                                            </p>
                        ...
                        <div class="col-lg-3 col-md-6 ">
                            <div class="footer-inner-wrap footer-col-block">
                                <h4 class="footer-title footer-title-desktop mb-28">Quick Links
                                </h4>
                                <h4 class="footer-title footer-title-mobile mb-28">Quick Links
                                </h4>
                        ...
                        <div class="col-lg-3 col-md-6 ">
                            <div class="footer-inner-wrap footer-col-block">
                                <h4 class="footer-title footer-title-desktop mb-23">Contact Us!
                                </h4>
                                <h4 class="footer-title footer-title-mobile mb-23">Contact Us!
                                </h4>
                                <ul class="contact-list tf-collapse-content">
                                    ...
                                    <li>
                                        ...
                                        <p class="phone-number fs-15">
                                            Call us: +91 98252 13146
                                        </p>
                                    </li>
                                    <li>
                                        <i class="icon-package-box"></i>
                                        <p class="email fs-15">
                                            Mail: sales@cropsto.in
                                        </p>
                                    </li>
                    ...
                    <div class="col-lg-12">
                        <div class="footer-bottom justify-content-center">
                            <p class="no-copy font-cropsto text-center">
                                Copyright © 2025 <span><a href="index.html">CropSto</a>.</span>
                                All Rights Reserved.
                            </p>
            ...
            <div class="img-item item-2">
                ...
                <div class="  scroll-element-3" style="transform: translateX(10px);">
                    <img class="wow zoomIn animated" src="images/new-home/footer-coffee.png" alt=""
                ...
                <div class="col-12">
                    <div class="offcanvas-body">
                        <form action="#" class="form-search-courses">
                            ...
                            <fieldset>
                                <input class="" type="text" placeholder="Search for anything" name="text" tabindex="2" value=""
...
<script>
    am5.ready(function () {
        ...
        var cities = [
            ...
            { title: "Ahmedabad (HQ)", latitude: 23.0215374, longitude: 72.5800568 },
            ...
            // new
            { title: "Ethiopia", latitude: 9.1450, longitude: 40.4897 },
            ...
            { title: "Ivory Coast", latitude: 7.5400, longitude: -5.5471 },
            { title: "Kenya", latitude: 1.2921, longitude: 36.8219 },
            { title: "Brazil", latitude: -14.2350, longitude: -51.9253 },
            { title: "Peru", latitude: -9.1900, longitude: -75.0152 },
            { title: "Colombia", latitude: 4.5709, longitude: -74.2973 },
            { title: "Dominican Republic", latitude: 18.7357, longitude: -70.1627 },
            { title: "Papua New Guinea", latitude: -6.3150, longitude: 143.9555 },
            { title: "Tanzania", latitude: -6.3690, longitude: 34.8888 },
            ...
            { title: "Cameroon", latitude: 3.8480, longitude: 11.5021 },
            ...
            { title: "Panama", latitude: 8.5380, longitude: -80.7821 },
            { title: "Vietnam", latitude: 14.0583, longitude: 108.2772 },
            { title: "Gabon", latitude: -0.8037, longitude: 11.6094 },
            { title: "Honduras", latitude: 15.2000, longitude: -86.2419 },
            ...
            { title: "Thailand", latitude: 15.8700, longitude: 100.9925 },
            { title: "Philippines", latitude: 12.8797, longitude: 121.7740 },
            { title: "Bolivia", latitude: -16.2902, longitude: -63.5887 },
            ...
            { title: "UK", latitude: 55.3781, longitude: -3.4360 },
