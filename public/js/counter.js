    ...
    $(window).on("scroll", function () {
        if ($(".odometer.style-4").length > 0) {
            if (isElementInViewport($(".odometer"))) {
                setTimeout(function () {
                    // $(".odometer.style-2").html(1999);
                    // $(".odometer.style-4").html(20);
                    // $(".odometer.style-4-2").html(1036);
                    // $(".odometer.style-4-3").html(40);                
                    // $(".odometer.style-4-4").html(2000);
                    $(".odometer.style-4").html(4.45);
                    $(".odometer.style-4-2").html(23);
                    $(".odometer.style-4-3").html(1.2);                
                    $(".odometer.style-4-4").html(3);
